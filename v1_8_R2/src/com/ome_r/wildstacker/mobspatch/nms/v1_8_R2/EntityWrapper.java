package com.ome_r.wildstacker.mobspatch.nms.v1_8_R2;
...
import net.minecraft.server.v1_8_R2.EntityGolem;
...
final class EntityWrapper {
    ...
    private static boolean damage(CraftLivingEntity livingEntity, double damage){
        EntityDamageEvent entityDamageEvent = new EntityDamageEvent(livingEntity, EntityDamageEvent.DamageCause.CUSTOM, damage);
    ...
    private static class CraftSquidWrapper extends CraftSquid {
        ...
        public void damage(double amount, org.bukkit.entity.Entity source) {
            ...
            if(reason != DamageSource.GENERIC || EntityWrapper.damage(this, amount))
