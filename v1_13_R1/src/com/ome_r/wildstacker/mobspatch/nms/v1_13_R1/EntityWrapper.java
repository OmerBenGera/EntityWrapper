package com.ome_r.wildstacker.mobspatch.nms.v1_13_R1;

import com.ome_r.wildstacker.mobspatch.events.EntityKillEvent;
import com.ome_r.wildstacker.mobspatch.events.EntityRemoveEvent;
...
import net.minecraft.server.v1_13_R1.EntityFish;
import net.minecraft.server.v1_13_R1.EntityFlying;
import net.minecraft.server.v1_13_R1.EntityGhast;
import net.minecraft.server.v1_13_R1.EntityGiantZombie;
import net.minecraft.server.v1_13_R1.EntityGolem;
...
import net.minecraft.server.v1_13_R1.EntityHorseChestedAbstract;
...
import net.minecraft.server.v1_13_R1.EntityIllagerAbstract;
import net.minecraft.server.v1_13_R1.EntityIllagerIllusioner;
import net.minecraft.server.v1_13_R1.EntityIllagerWizard;
...
import net.minecraft.server.v1_13_R1.EntityWaterAnimal;
...
import org.bukkit.craftbukkit.v1_13_R1.entity.CraftIllager;
...
final class EntityWrapper {
    ...
    private static void remove(CraftLivingEntity livingEntity){
        EntityRemoveEvent entityRemoveEvent = new EntityRemoveEvent(livingEntity);
